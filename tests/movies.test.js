...
describe("POST /api/movies", () => {
  ...
  it("should return an error", async () => {
    const movieWithMissingProps = { director: "Harry Potter" };
  ...
  it("should return an error", async () => {
    const movieWithMissingProps = { year: "1960" };
...
describe("PUT /api/movies/:id", () => {
  ...
  it("should return an error", async () => {
    ...
    it("should return an error", async () => {
      ...
      it("should return an error", async () => {
        const movieWithMissingProps = { year: "1680" };
        ...
        it("should return an error", async () => {
          const movieWithMissingProps = { color: "0" };
          ...
          it("should return an error", async () => {
            const movieWithMissingProps = { duration: "240" };
